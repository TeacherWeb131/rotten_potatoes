...
class Movie
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\People", mappedBy="actedInMovies")
     */
    private $actors;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\People", inversedBy="directedMovies")
     */
    private $director;
